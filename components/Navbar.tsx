...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="w-[95%] max-w-7xl mx-auto z-50 bg-orange-400/50 backdrop-blur-md text-white font-semibold px-6 py-3 rounded-b-2xl shadow-lg flex justify-between items-center">
